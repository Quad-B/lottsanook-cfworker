...
router.get('/index2', async (ctx) => {
    ...
    if (ctx.query.date.substring(4, 8) == new Date().getFullYear() + 543) {
        ...
        await fetch('https://www.myhora.com/lottery/result-' + ctx.query.date.substring(0, 2) + '-' + ctx.query.date.substring(2, 4) + '-' + ctx.query.date.substring(4, 8) + '.aspx', { redirect: "error" })
            .then(res => res.text())
            .then((body) => {
...
router.get('/gdpy', async (ctx) => {
    ...
    await fetch('https://www.myhora.com/lottery/result-' + ctx.query.year + '.aspx')
        .then(res => res.text())
        .then((body) => {
